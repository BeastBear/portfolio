...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Phurich Srikongyos
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm undergraduate in Computer Engineering in KMUNTB, 
        and this is my first portfolio.
        </p>
